...
const Rules: React.SFC<RulesProps> = () => {
  ...
  if (loading) return <div><h3>Game Settings:</h3> Unless otherwise specified, the following settings must be set to following:
  <ul>
  <li>Fatigue: ON</li>
  ...
  <h3>Online Squads Only:</h3> Matches must be played with Online Squads only. You are not allowed to import a team or a franchise.</div>
